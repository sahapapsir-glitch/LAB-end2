...
function initializeAddToCartButtons() {
    const addToCartButtons = document.querySelectorAll('.add-to-cart-btn, .product-add-btn, .add-to-cart-btn-custom');
    ...
    addToCartButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const product = {
                ...
                price: parseInt(card.querySelector('.price, .product-price').textContent.replace(/[^\d]/g, '')),
